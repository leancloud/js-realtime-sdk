...
var _Array$some = _interopDefault(require('babel-runtime/core-js/array/some'));
...
var Conversation = function (_EventEmitter) {
  ...
  Conversation.prototype.read = function read() {
    ...
    // 跳过暂态会话、系统对话
    if (this.transient || this.system) return _Promise.resolve(this);
...
var MessageParser = (_class$2 = function () {
  ...
  MessageParser.prototype.parse = function parse(content) {
    debug$9('parsing message: %O', content);
    // eslint-disable-next-line no-restricted-syntax
...
var Realtime = function (_EventEmitter) {
  ...
  Realtime.prototype._dispatchMessage = function _dispatchMessage(message) {
    if (message.peerId !== null) {
      ...
      return debug('[WARN] Unexpected message received without any live client match: %O', trim(message));
    }
