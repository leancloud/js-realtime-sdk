...
var Conversation = function (_EventEmitter) {
  ...
  function Conversation(_ref, client) {
    ...
    _this._attributes = decode$1(attributes);
    _this._reset();
...
var IMClient = (_dec = throttle(1000), _dec2 = throttle(1000), (_class$1 = function (_EventEmitter) {
  ...
  IMClient.prototype.parseConversation = function () {
    var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(json) {
  ...
  IMClient.prototype._parseConversationFromRawData = function () {
    var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(rawData) {
      var data, message;
      return _regeneratorRuntime.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              if (data.bin) {
                data.lastMessage = base64Arraybuffer.decode(data.lastMessage);
              }
              _context12.next = 5;
