(function (global, factory) {
    ...
    var require$$1 = (_iterators && typeof _iterators === 'object' && 'default' in _iterators ? _iterators['default'] : _iterators);
    ...
    var require$$0$5 = (_cof && typeof _cof === 'object' && 'default' in _cof ? _cof['default'] : _cof);
    ...
    var require$$14 = (_classof && typeof _classof === 'object' && 'default' in _classof ? _classof['default'] : _classof);

    var core_getIteratorMethod = createCommonjsModule(function (module) {
    var classof   = require$$14
    ...
    var require$$0$4 = (core_getIteratorMethod && typeof core_getIteratorMethod === 'object' && 'default' in core_getIteratorMethod ? core_getIteratorMethod['default'] : core_getIteratorMethod);
    ...
    var require$$0$2 = (core_getIterator && typeof core_getIterator === 'object' && 'default' in core_getIterator ? core_getIterator['default'] : core_getIterator);
    ...
    var require$$0$8 = (_defined && typeof _defined === 'object' && 'default' in _defined ? _defined['default'] : _defined);

    var _toObject = createCommonjsModule(function (module) {
    // 7.1.13 ToObject(argument)
    var defined = require$$0$8;
    module.exports = function(it){
    ...
    var require$$1$1 = (_objectGpo && typeof _objectGpo === 'object' && 'default' in _objectGpo ? _objectGpo['default'] : _objectGpo);
    ...
    var require$$0$10 = (_fails && typeof _fails === 'object' && 'default' in _fails ? _fails['default'] : _fails);

    var _descriptors = createCommonjsModule(function (module) {
    // Thank's IE8 for his funny defineProperty
    module.exports = !require$$0$10(function(){
      return Object.defineProperty({}, 'a', {get: function(){ return 7; }}).a != 7;
    });
    });

    var require$$1$2 = (_descriptors && typeof _descriptors === 'object' && 'default' in _descriptors ? _descriptors['default'] : _descriptors);
    ...
    var require$$2$3 = (_domCreate && typeof _domCreate === 'object' && 'default' in _domCreate ? _domCreate['default'] : _domCreate);

    var _ie8DomDefine = createCommonjsModule(function (module) {
    module.exports = !require$$1$2 && !require$$0$10(function(){
      return Object.defineProperty(require$$2$3('div'), 'a', {get: function(){ return 7; }}).a != 7;
    });
    });

    var require$$1$3 = (_ie8DomDefine && typeof _ie8DomDefine === 'object' && 'default' in _ie8DomDefine ? _ie8DomDefine['default'] : _ie8DomDefine);

    var _objectDp = createCommonjsModule(function (module, exports) {
    var anObject       = require$$2
      , IE8_DOM_DEFINE = require$$1$3
      , toPrimitive    = require$$3$1
      , dP             = Object.defineProperty;

    exports.f = require$$1$2 ? Object.defineProperty : function defineProperty(O, P, Attributes){
      anObject(O);
    ...
    var require$$0$9 = (_objectDp && typeof _objectDp === 'object' && 'default' in _objectDp ? _objectDp['default'] : _objectDp);

    var _setToStringTag = createCommonjsModule(function (module) {
    var def = require$$0$9.f
      , has = require$$2$2
      , TAG = require$$19('toStringTag');
    ...
    module.exports = require$$1$2 ? function(object, key, value){
    ...
    var require$$0$11 = (_hide && typeof _hide === 'object' && 'default' in _hide ? _hide['default'] : _hide);
    ...
    var require$$0$13 = (_enumBugKeys && typeof _enumBugKeys === 'object' && 'default' in _enumBugKeys ? _enumBugKeys['default'] : _enumBugKeys);
    ...
    module.exports = require$$1$2 ? Object.defineProperties : function defineProperties(O, Properties){
      anObject(O);
    ...
    var require$$0$12 = (_objectCreate && typeof _objectCreate === 'object' && 'default' in _objectCreate ? _objectCreate['default'] : _objectCreate);

    var _iterCreate = createCommonjsModule(function (module) {
    'use strict';
    var create         = require$$0$12
      , descriptor     = require$$5
      , setToStringTag = require$$21
      , IteratorPrototype = {};

    // 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
    require$$0$11(IteratorPrototype, require$$19('iterator'), function(){ return this; });
    ...
    var require$$1$11 = (_aFunction && typeof _aFunction === 'object' && 'default' in _aFunction ? _aFunction['default'] : _aFunction);
    ...
    var require$$1$10 = (_ctx && typeof _ctx === 'object' && 'default' in _ctx ? _ctx['default'] : _ctx);
    ...
    var require$$1$12 = (_library && typeof _library === 'object' && 'default' in _library ? _library['default'] : _library);

    var _iterDefine = createCommonjsModule(function (module) {
    'use strict';
    var LIBRARY        = require$$1$12
      , $export        = require$$2$4
      , redefine       = require$$25
      , hide           = require$$0$11
      , has            = require$$2$2
    ...
    var require$$0$6 = (_iterDefine && typeof _iterDefine === 'object' && 'default' in _iterDefine ? _iterDefine['default'] : _iterDefine);
    ...
    var require$$1$13 = (_stringAt && typeof _stringAt === 'object' && 'default' in _stringAt ? _stringAt['default'] : _stringAt);

    var es6_string_iterator = createCommonjsModule(function (module) {
    'use strict';
    var $at  = require$$1$13(true);
    ...
    module.exports = require$$0$6(Array, 'Array', function(iterated, kind){
    ...
    var require$$0$1 = (getIterator$1 && typeof getIterator$1 === 'object' && 'default' in getIterator$1 ? getIterator$1['default'] : getIterator$1);

    var getIterator = createCommonjsModule(function (module) {
    module.exports = { "default": require$$0$1, __esModule: true };
    });

    var require$$0 = (getIterator && typeof getIterator === 'object' && 'default' in getIterator ? getIterator['default'] : getIterator);

    var core_isIterable = createCommonjsModule(function (module) {
    var classof   = require$$14
      , ITERATOR  = require$$19('iterator')
      , Iterators = require$$1;
    module.exports = require$$0$3.isIterable = function(it){
      var O = Object(it);
    ...
    var require$$0$17 = (core_isIterable && typeof core_isIterable === 'object' && 'default' in core_isIterable ? core_isIterable['default'] : core_isIterable);

    var isIterable$1 = createCommonjsModule(function (module) {
    module.exports = require$$0$17;
    });

    var require$$0$16 = (isIterable$1 && typeof isIterable$1 === 'object' && 'default' in isIterable$1 ? isIterable$1['default'] : isIterable$1);

    var isIterable = createCommonjsModule(function (module) {
    module.exports = { "default": require$$0$16, __esModule: true };
    });

    var require$$1$14 = (isIterable && typeof isIterable === 'object' && 'default' in isIterable ? isIterable['default'] : isIterable);
    ...
    var _isIterable2 = require$$1$14;

    var _isIterable3 = _interopRequireDefault(_isIterable2);

    var _getIterator2 = require$$0;
    ...
    if(!setTask || !clearTask){
      ...
      // Node.js 0.8-
      if(require$$0$5(process) == 'process'){
        defer = function(id){
    ...
    var global    = require$$29
      ...
      , isNode    = require$$0$5(process) == 'process';
    ...
    var require$$3$5 = (_isArrayIter && typeof _isArrayIter === 'object' && 'default' in _isArrayIter ? _isArrayIter['default'] : _isArrayIter);
    ...
    var ctx         = require$$1$10
      , call        = require$$4$5
      , isArrayIter = require$$3$5
      , anObject    = require$$2
      , toLength    = require$$1$8
      , getIterFn   = require$$0$4
      , BREAK       = {}
      , RETURN      = {};
    ...
    var require$$0$18 = (promise$1 && typeof promise$1 === 'object' && 'default' in promise$1 ? promise$1['default'] : promise$1);
    ...
    module.exports = !$assign || require$$0$10(function(){
      var A = {}
        , B = {}
        , S = Symbol()
    ...
    var require$$0$21 = (_objectAssign && typeof _objectAssign === 'object' && 'default' in _objectAssign ? _objectAssign['default'] : _objectAssign);

    var es6_object_assign = createCommonjsModule(function (module) {
    // 19.1.3.1 Object.assign(target, source)
    var $export = require$$2$4;

    $export($export.S + $export.F, 'Object', {assign: require$$0$21});
    });
    ...
    var require$$0$20 = (assign$1 && typeof assign$1 === 'object' && 'default' in assign$1 ? assign$1['default'] : assign$1);
    ...
    var require$$0$26 = (_wksExt && typeof _wksExt === 'object' && 'default' in _wksExt ? _wksExt['default'] : _wksExt);

    var _wksDefine = createCommonjsModule(function (module) {
    var global         = require$$29
      , core           = require$$0$3
      , LIBRARY        = require$$1$12
      , wksExt         = require$$0$26
      , defineProperty = require$$0$9.f;
    ...
    var $keys      = require$$1$5
      , hiddenKeys = require$$0$13.concat('length', 'prototype');
    ...
    exports.f = require$$1$2 ? gOPD : function getOwnPropertyDescriptor(O, P){
      O = toIObject(O);
      P = toPrimitive(P, true);
      if(IE8_DOM_DEFINE)try {
        return gOPD(O, P);
    ...
    var META     = require$$4('meta')
      , isObject = require$$3
      , has      = require$$2$2
      , setDesc  = require$$0$9.f
      , id       = 0;
    var isExtensible = Object.isExtensible || function(){
      return true;
    };
    var FREEZE = !require$$0$10(function(){
    ...
    $Symbol[PROTOTYPE][TO_PRIMITIVE] || require$$0$11($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
    ...
    var require$$0$25 = (index && typeof index === 'object' && 'default' in index ? index['default'] : index);

    var symbol = createCommonjsModule(function (module) {
    module.exports = { "default": require$$0$25, __esModule: true };
    });

    var require$$0$24 = (symbol && typeof symbol === 'object' && 'default' in symbol ? symbol['default'] : symbol);

    var iterator$1 = createCommonjsModule(function (module) {
    module.exports = require$$0$26.f('iterator');
    });

    var require$$0$29 = (iterator$1 && typeof iterator$1 === 'object' && 'default' in iterator$1 ? iterator$1['default'] : iterator$1);
    ...
    var require$$0$23 = (_typeof && typeof _typeof === 'object' && 'default' in _typeof ? _typeof['default'] : _typeof);
    ...
    var $export = require$$2$4
    // 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
    $export($export.S, 'Object', {create: require$$0$12});
    });
    ...
    module.exports = {
      set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
        function(test, buggy, set){
          try {
            set = require$$1$10(Function.call, require$$0$28.f(Object.prototype, '__proto__').set, 2);
            set(test, []);
    ...
    var require$$0$32 = (_setProto && typeof _setProto === 'object' && 'default' in _setProto ? _setProto['default'] : _setProto);

    var es6_object_setPrototypeOf = createCommonjsModule(function (module) {
    // 19.1.3.19 Object.setPrototypeOf(O, proto)
    var $export = require$$2$4;
    $export($export.S, 'Object', {setPrototypeOf: require$$0$32.set});
    });
    ...
    var EventEmitter = (index$1 && typeof index$1 === 'object' && 'default' in index$1 ? index$1['default'] : index$1);

    var es6_object_defineProperty = createCommonjsModule(function (module) {
    var $export = require$$2$4;
    // 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
    $export($export.S + $export.F * !require$$1$2, 'Object', {defineProperty: require$$0$9.f});
    });
    ...
    var require$$0$34 = (defineProperty$1 && typeof defineProperty$1 === 'object' && 'default' in defineProperty$1 ? defineProperty$1['default'] : defineProperty$1);

    var defineProperty = createCommonjsModule(function (module) {
    module.exports = { "default": require$$0$34, __esModule: true };
    });

    var require$$0$33 = (defineProperty && typeof defineProperty === 'object' && 'default' in defineProperty ? defineProperty['default'] : defineProperty);
    ...
    var _defineProperty = require$$0$33;
    ...
    */
    ...
    var createCallStateMachine = function createCallStateMachine() {
    ...
    */
    ...
    var require$$0$35 = (inherit$1 && typeof inherit$1 === 'object' && 'default' in inherit$1 ? inherit$1['default'] : inherit$1);
    ...
    var inherit = (index$2 && typeof index$2 === 'object' && 'default' in index$2 ? index$2['default'] : index$2);
