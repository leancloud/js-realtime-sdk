(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('avoscloud-sdk'), require('leancloud-realtime')) :
    typeof define === 'function' && define.amd ? define('typed-messages', ['exports', 'avoscloud-sdk', 'leancloud-realtime'], factory) :
    (factory((global.AV = global.AV || {}),global.AV,global.AV));
}(this, function (exports,avoscloudSdk,leancloudRealtime) { 'use strict';

    var __commonjs_global = typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : this;
    function __commonjs(fn, module) { return module = { exports: {} }, fn(module, module.exports, __commonjs_global), module.exports; }

    if (!avoscloudSdk.File) {
    ...
    */
    ...
    var FileMessage = inherit(leancloudRealtime.TypedMessage, /** @lends FileMessage.prototype */{
      ...
      __constructor: function __constructor(file) {
        if (!(file instanceof avoscloudSdk.File)) {
      ...
      _parseFileFromRawData: function _parseFileFromRawData(data) {
        ...
        var file = avoscloudSdk.File.createWithoutData(id);
    ...
    var LocationMessage = inherit(leancloudRealtime.TypedMessage, /** @lends LocationMessage.prototype */{
      ...
      __constructor: function __constructor(geoPoint) {
        if (!(geoPoint instanceof avoscloudSdk.GeoPoint)) {
      ...
      parse: function parse(json, message) {
        ...
        var geoPoint = new avoscloudSdk.GeoPoint({ latitude: latitude, longitude: longitude });
